  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        2. <strong>หาก app เปิดอยู่:</strong> จะแสดงการแจ้งเตือนภายใน app (มุมขวาบน)<br />
        3. <strong>หาก app ปิดอยู่:</strong> จะแสดงการแจ้งเตือนของ browser<br />
      ...
      <div style={{ 
        ...
        • ถ้าไม่เห็นการแจ้งเตือน ลองปิด app tab แล้วส่งใหม่<br />
